...
export default {
  ...
  // named import from lodash leads to a large bundle size. Tree shaking is not possible.
  ...
  'no-restricted-imports': [
    'error',
    {
      paths: [
        {
          name: 'lodash',
          message: "Please use `import XXX from 'lodash/XXX'` instead.",
        },
      ],
    },
  ],
  ...
  'simple-import-sort/imports': [
    'warn',
    {
      groups: [
        ...
        ['^@?\\w'],
        // Aliased local imports (e.g., #app, #whatever).
        ['^#'],
